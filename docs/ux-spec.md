...
Between the gallery and How Jev rules. It makes the site feel lived in without showing anyone: foods that passed the listing checks, as the court heard them, never who asked and never a time. The lists started with the listed question set 7 eval rulings, so the section has something to show from day one.
