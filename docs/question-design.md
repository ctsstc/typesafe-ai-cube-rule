...
- **Personal info patterns are simple.** They miss spelled-out numbers ("five five five..."), addresses and names split across unusual spacing. The person gate and the blocklist cover some of that.
